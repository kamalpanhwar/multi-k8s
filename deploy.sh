...
kubectl set image deployments/client-deployment client=kamalpanhwar/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=kamalpanhwar/multi-worker:$SHA
